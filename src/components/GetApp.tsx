      ...
      <div className="get-app sm:gap-2">
        ...
        <div className="flex flex-1 items-center justify-center lg:w-1/2 p-6">
          <form method="POST" onSubmit={handleSubmit} className="w-full max-w-md">
            <div className="mb-4">
              <label htmlFor="name" className="block text-base font-medium text-white bold-20">Name</label>
              <input
                type="text"
                id="name"
            ...
            <div className="mb-4">
              <label htmlFor="email" className="block text-base font-medium text-white bold-20">Email</label>
              <input
                type="email"
                id="email"
            ...
            <div className="mb-4">
              <label htmlFor="phoneNumber" className="block text-base font-medium text-white bold-20">Phone Number</label>
              <input
                type="tel"
                id="phoneNumber"
            ...
            <div className="mb-4">
              <label htmlFor="message" className="block text-base font-medium text-white bold-20">Message</label>
              <textarea
                id="message"
            ...
            <div className="flex items-center justify-between">
              <button
                type="submit"
                className={`bg-[color:var(--surface)] hover:bg-green-100 text-green-700 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                disabled={loading}
              >
