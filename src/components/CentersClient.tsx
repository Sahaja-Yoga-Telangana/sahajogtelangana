...
const languageCopy = {
  en: {
    ...
    view_details: "View center details",
  },
  te: {
    title: "మాతో కలవండి",
    ...
    view_details: "కేంద్ర వివరాలు చూడండి",
  },
} as const;
            ...
            <article key={center._id} className="rounded-[28px] border border-[color:var(--border)] bg-[color:var(--surface)] p-5 shadow-soft">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <Link href={`/centers/${centerSlug(center)}`} className="mt-2 inline-block text-2xl font-semibold text-[color:var(--ink)] transition-colors hover:text-[color:var(--primary)]">
                    {center.zone}
                  </Link>
              ...
              <div className="mt-5 flex items-center justify-between gap-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center rounded-full border border-[color:var(--border)] px-4 py-2 text-sm font-semibold text-[color:var(--ink)] transition-colors hover:bg-[color:var(--surface-2)]"
                >
                  {copy.view_details}
                </Link>
              </div>
